...
class CFtpServer
{
	...
	public:
		...
		#else
            void OnServerEventCb( int Event ) const {Q_UNUSED(Event);}
            void OnUserEventCb( int Event, CFtpServer::CUserEntry *pUser, void *pArg = NULL ) const {Q_UNUSED(Event);Q_UNUSED(pUser);Q_UNUSED(pArg);}
            void OnClientEventCb( int Event, CFtpServer::CClientEntry *pClient, void *pArg = NULL ) const {Q_UNUSED(Event);Q_UNUSED(pClient);Q_UNUSED(pArg);}
