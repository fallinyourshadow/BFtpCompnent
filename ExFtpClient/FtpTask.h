...
signals:
    ...
    //void sendDir(QString filepath, QString objfilepath, QString objfileName)
    ...
    void dirRemoved(QString objfilepath, QString objfileName);
    void reTried();
    //对外信号
...
public:
    ...
    void removeDir(const QString & objfilepath, const QString & objfileName);
    //成员变量操作
    const QList<QUrlInfo> &infoList();
    // QString errMsg();//获取错误信息
